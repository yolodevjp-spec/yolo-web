...
export const metadata: Metadata = {
  title: "Finance | Vertical SaaS Hunter",
  description: "財務・会計の記事。Coming soon。",
  openGraph: { title: "Finance | Vertical SaaS Hunter", description: "財務の記事。" },
};
  ...
  return (
    <div className="min-h-screen bg-black text-white flex-1">
      ...
      <main className="max-w-7xl mx-auto px-4 py-10">
        <h1 className="text-4xl font-black mb-10 border-l-8 border-red-600 pl-4 uppercase">Finance Feed</h1>
